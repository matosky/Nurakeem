    ...
    <section className="bg-white mt-20">
      <Container>
        ...
        <div className="text-primary">
          <p className="text-base font-open-sans font-normal mobile_lg:leading-[30px] leading-[40px] text-left">
            ...
            care program that maximizes the client&#39;s independence and dignity.<br />
            ...
            commit in the building of a community that is characterised by
            understanding and acceptance of those with Mental Health and any
            form of disability, especially Adults and the Elderly.<br />
