...
function Footer() {
  return (
    <footer className="bg-nurakeemFooterBg  pt-6 pb-10">
      <Container>
        <section className="flex justify-between space-x-12  py-10">
            ...
            <div className="text-white">
              {services.map((s, index) => (
                <div key={index} className="flex items-center mb-4 gap-2">
                  ...
                  <span className="font-normal leading-[30px] text-left">
                    {s.text}
                  </span>
                </div>
              ))}
          ...
          <div className="flex-1">
            ...
            <div className="text-white">
              ...
              <p className="font-normal leading-[30px] text-left mt-4">
                <span className="font-bold flex items-center gap-1"><FaPhone className="mt-[-4px] text-white" /> 07904451016</span>
              </p>
            </div>
          </div>
        </section>
      ...
      <section>
        <Container>
          <div>
            <p className="w-full text-center mb-4 font-normal leading-[43px]">
